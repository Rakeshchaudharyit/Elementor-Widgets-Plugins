...
class BDevs_El_Woocommerce
{
    ...
    public static function add_to_cart_hover_button($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            ...
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" data-toggle="tooltip" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s p-btn-white add_to_cart_button bdevs-btn">buy now</a>',
    ...
    public static function add_to_cart_button($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            ...
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" data-toggle="tooltip" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s m-btn m-btn-5 add_to_cart_button bdevs-btn">buy now</a>',
                    esc_url($product->add_to_cart_url()),
                    esc_attr(isset($quantity) ? $quantity : 1),
                    esc_attr($product->get_id()),
                    esc_attr($product->get_sku()),
    ...
    public static function add_to_cart_button_icon($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            $product = wc_get_product($product_id);
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" data-toggle="tooltip" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s add_to_cart_button link_heart"><i class="fal fa-shopping-cart"></i></a>',
                    esc_url($product->add_to_cart_url()),
                    esc_attr(isset($quantity) ? $quantity : 1),
                    esc_attr($product->get_id()),
                    esc_attr($product->get_sku()),
    ...
    public static function add_to_cart_button_iconsss($product_id)
    {
        if (BDEVSEL_WOOCOMMERCE_ACTIVED) {
            $product = wc_get_product($product_id);
            if ($product) {
                ...
                return sprintf('<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s add_to_cart_button link_heart">+</a>',
                    esc_url($product->add_to_cart_url()),
                    esc_attr(isset($quantity) ? $quantity : 1),
                    esc_attr($product->get_id()),
                    esc_attr($product->get_sku()),
    ...
    public static function product_rating($product_id)
    {
        ...
        $html = '';
        $html .= '<div class="product__ratings" title="' . $review . '">';
    ...
    public static function downloadable_count_el($product_id) {
        $product = wc_get_product($product_id);
