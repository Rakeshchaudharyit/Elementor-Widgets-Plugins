...
class BDevs_El_Assets {
	...
	public static function enqueue_scripts(){
		...
		wp_enqueue_script('wb-slick-library', BDEVSEL_ASSETS . 'js/slick.min.js', ['jquery'], '1.0.0', true);
		wp_enqueue_script('wpce-main', BDEVSEL_ASSETS . 'js/bdevs-element.js', ['wb-slick-library'], '1.0.0', true);
	}
